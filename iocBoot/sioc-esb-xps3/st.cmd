...
epicsEnvSet("LOC","NLCTA Gun Rack")
...
XPSCreateAxis("XPS$(N)",0,"Group1.Pos",20000)
XPSCreateAxis("XPS$(N)",1,"Group2.Pos",20000)
XPSCreateAxis("XPS$(N)",2,"Group3.Pos",20000)
XPSCreateAxis("XPS$(N)",3,"Group4.Pos",20000)
XPSCreateAxis("XPS$(N)",4,"Group5.Pos",20000)
XPSCreateAxis("XPS$(N)",5,"Group6.Pos",20000)
XPSCreateAxis("XPS$(N)",6,"Group7.Pos",20000)
